...
package com.skyworth.yunintelligentcontrol.view.materialspinner;
...
public class MaterialSpinner extends TextView {
	...
	/**
	 * Register a callback to be invoked when an item in the dropdown is
	 * selected.
	 *
	...
	/**
	 * Register a callback to be invoked when the {@link PopupWindow} is shown
	 * but the user didn't select an item.
	 *
	 ...
	 *
	 * @return The {@link PopupWindow} that is displayed when the view has been
	 *         clicked.
	 */
	...
	/**
	 * Interface definition for a callback to be invoked when the dropdown is
	 * dismissed and no item was selected.
	 */
	public interface OnNothingSelectedListener {

		/**
		 * Callback method to be invoked when the {@link PopupWindow} is
		 * dismissed and no item was selected.
		 *
		 * @param spinner
