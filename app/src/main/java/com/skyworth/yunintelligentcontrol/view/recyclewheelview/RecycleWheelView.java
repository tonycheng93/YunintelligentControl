...
public class RecycleWheelView extends RecyclerView {
    ...
    void initAttr(AttributeSet attrs, int defStyle) {
        ...
        final TypedArray a = getContext().obtainStyledAttributes(attrs, R.styleable.RecycleWheelView, defStyle, 0);
...
//    }
    ...
    public void onDraw(Canvas c) {
        ...
        // drawable.setBounds(startLeft, mDrawablePadding, startLeft +
        // mLineThickness, getHeight() - mDrawablePadding);
        // drawable.draw(c);
        ...
        // drawable.setBounds(mDrawablePadding, startTop, getWidth() -
        // mDrawablePadding, startTop + mLineThickness);
        // drawable.draw(c);
